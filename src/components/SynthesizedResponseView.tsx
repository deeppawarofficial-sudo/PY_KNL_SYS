        ...
        if (citation) {
          return (
            <button
              ...
              className="inline-flex items-center gap-1 mx-1 px-1.5 py-0.5 text-xs font-mono font-semibold text-blue-300 bg-blue-950/90 hover:bg-blue-900 border border-blue-700/80 rounded transition-all cursor-pointer shadow-sm hover:scale-105"
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-wrap items-center justify-between gap-4 shadow-2xs">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 text-xs font-mono font-semibold bg-blue-50 text-blue-700 border border-blue-200 rounded">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 border border-blue-600 rounded-lg transition-colors cursor-pointer shadow-2xs"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {result.citations.map((cite) => (
            <div
              ...
              className="group bg-slate-800/50 hover:bg-blue-50/60 border border-slate-800 hover:border-blue-300 p-3.5 rounded-lg transition-all cursor-pointer flex flex-col justify-between gap-2"
            >
              <div className="space-y-1">
                <div className="flex items-center justify-between gap-2">
                  <span className="px-1.5 py-0.5 text-xs font-mono font-bold text-blue-700 bg-slate-900 border border-slate-800 rounded">
                    [{cite.citationId}]
                  </span>
                  <span className="text-[11px] text-slate-500 font-mono">Page {cite.pageNumber}</span>
                </div>
                <h4 className="text-xs font-semibold text-slate-100 group-hover:text-blue-900 transition-colors line-clamp-1">
                  {cite.paperTitle}
                </h4>
