          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <button
                ...
                className="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-950/50 transition-all cursor-pointer whitespace-nowrap"
              >
                {isGenerating ? (
                  <>
          ...
          {!review && !isGenerating ? (
            ...
            <div className="py-16 text-center space-y-4 animate-pulse">
              ...
              <div className="space-y-1">
                <p className="text-xs font-mono text-blue-300 font-bold">Scanning Vector Repository & Indexing Chunks...</p>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3.5 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 shadow-md shadow-blue-950/50 transition-all cursor-pointer"
                  >
              ...
              <div className="space-y-4 bg-slate-950 p-6 rounded-2xl border border-slate-800 text-slate-200 leading-relaxed font-sans">
                {review?.executiveSummary && (
                  <div className="p-4 bg-blue-950/40 border border-blue-800/40 rounded-xl space-y-1 text-slate-200">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-blue-400">Executive Summary</span>
                    ...
                    {review.citations.map((c) => (
                      <div key={c.citationId} className="p-3 bg-slate-950 rounded-xl border border-slate-800 space-y-1">
                        <div className="flex items-center justify-between text-[11px]">
                          <span className="font-mono font-bold text-blue-400">[{c.citationId}] {c.paperTitle}</span>
