            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className="flex items-center gap-1.5 text-xs text-slate-300">
                ...
                <select
                  ...
                  className="bg-slate-900 border border-slate-700 text-slate-100 rounded-lg px-2.5 py-1.5 text-xs font-medium outline-none focus:border-emerald-500 cursor-pointer"
                >
              ...
              <button
                ...
                className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-xs rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-emerald-950/50 transition-all cursor-pointer whitespace-nowrap"
              >
                {isGenerating ? (
                  <>
        ...
        <div className="p-6 overflow-y-auto space-y-5 max-h-[65vh] text-xs leading-relaxed text-slate-200">
          {!review && !isGenerating ? (
            <div className="text-center py-16 text-slate-400 space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-slate-800/80 border border-slate-700 flex items-center justify-center mx-auto text-emerald-400">
            ...
            <div className="py-16 text-center space-y-4 animate-pulse">
              ...
              <div className="space-y-1">
                <p className="text-xs font-mono text-emerald-300 font-bold">Scanning Vector Repository & Indexing Chunks...</p>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 shadow-md shadow-emerald-950/50 transition-all cursor-pointer"
                  >
              ...
              <div className="space-y-4 bg-slate-950 p-6 rounded-2xl border border-slate-800 text-slate-200 leading-relaxed font-sans">
                {review?.executiveSummary && (
                  <div className="p-4 bg-emerald-950/40 border border-emerald-800/40 rounded-xl space-y-1 text-slate-200">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-emerald-400">Executive Summary</span>
                    ...
                    {review.citations.map((c) => (
                      <div key={c.citationId} className="p-3 bg-slate-950 rounded-xl border border-slate-800 space-y-1">
                        <div className="flex items-center justify-between text-[11px]">
                          <span className="font-mono font-bold text-emerald-400">[{c.citationId}] {c.paperTitle}</span>
