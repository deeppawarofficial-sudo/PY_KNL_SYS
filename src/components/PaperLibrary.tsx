      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-2xs flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-800/50 border border-slate-800 focus:border-amber-600 focus:bg-slate-900 rounded-lg pl-9 pr-4 py-2 text-xs text-slate-100 placeholder-slate-600 outline-none transition-all"
          />
        </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-10 text-center space-y-4 shadow-2xs">
              ...
              <div className="flex items-center justify-center gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-3.5 py-2 text-xs font-semibold text-white bg-amber-600 hover:bg-amber-700 rounded-lg transition-colors cursor-pointer"
                >
                  Upload PDF Paper
                </button>
              </div>
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 text-[10px] font-mono font-bold bg-slate-800 text-amber-700 border border-slate-800 rounded">
                            {paper.topicCategory}
                          </span>
                          {paper.arxivId && (
                    ...
                    <div className="flex items-center justify-between text-[11px] text-slate-500 border-t border-slate-800/80 pt-2.5">
                      ...
                      <div className="flex items-center gap-3 font-mono text-slate-500">
                        ...
                        <span>&bull;</span>
                        <span className="text-amber-600 font-bold">{paper.chunkCount} Chunks</span>
                      </div>
                    </div>
                  </div>
                );
          ...
          {selectedPaper ? (
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-2xs space-y-5 sticky top-20 max-h-[85vh] flex flex-col overflow-hidden">
              <div className="border-b border-slate-800 pb-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded bg-amber-50 border border-amber-200 flex items-center justify-center text-amber-600 font-bold">
              ...
              <div className="space-y-2">
                ...
                {selectedPaper.pdfUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-xs text-amber-600 font-medium hover:underline pt-1"
                  >
              ...
              <div className="overflow-y-auto space-y-3 pr-1">
                {isLoadingChunks ? (
                  ...
                  paperChunks.map((chunk) => (
                    ...
                    >
                      <div className="flex items-center justify-between text-[11px] font-mono font-bold text-amber-700">
