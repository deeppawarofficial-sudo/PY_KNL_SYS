      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-2xs flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-800/50 border border-slate-800 focus:border-emerald-600 focus:bg-slate-900 rounded-lg pl-9 pr-4 py-2 text-xs text-slate-100 placeholder-slate-600 outline-none transition-all"
          />
        </div>
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          <span className="px-2 py-0.5 text-[10px] font-mono font-bold bg-slate-800 text-emerald-700 border border-slate-800 rounded">
                            {paper.topicCategory}
                          </span>
                          {paper.arxivId && (
                            <span className="px-2 py-0.5 text-[10px] font-mono bg-emerald-50 text-emerald-700 border border-emerald-200 rounded">
                              ArXiv: {paper.arxivId}
                            </span>
                          )}
                        </div>
                    ...
                    <div className="flex items-center justify-between text-[11px] text-slate-500 border-t border-slate-800/80 pt-2.5">
                      ...
                      <div className="flex items-center gap-3 font-mono text-slate-500">
                        ...
                        <span>&bull;</span>
                        <span className="text-emerald-600 font-bold">{paper.chunkCount} Chunks</span>
                      </div>
                    </div>
                  </div>
                );
