      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={loadMatrix}
            disabled={isLoading}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-cyan-50 hover:bg-cyan-100 text-cyan-700 border border-cyan-200 rounded-lg text-xs font-semibold transition-colors cursor-pointer"
          >
              ...
              <tbody className="divide-y divide-slate-200 text-slate-200">
                {matrixData.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-800/50 transition-colors">
                    <td className="p-4 font-bold text-cyan-700 bg-slate-800/50/50">
                    ...
                    <td className="p-4 text-cyan-800 leading-normal font-medium bg-cyan-50/60">
                    ...
                    <td className="p-4 font-mono font-semibold text-cyan-700">
                      {item.queryLatency}
                    </td>
                  </tr>
                ))}
