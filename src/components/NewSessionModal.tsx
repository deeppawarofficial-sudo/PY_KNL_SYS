      ...
      <div className="bg-slate-900 rounded-2xl border border-slate-800 shadow-2xl max-w-md w-full p-6 space-y-6 relative">
        ...
        <div className="space-y-3">
          ...
          <div
            ...
            className={`p-4 rounded-xl border transition-all cursor-pointer flex items-start gap-3.5 ${
              selectedMode === 'empty'
                ? 'bg-cyan-50/80 border-cyan-600 shadow-2xs'
                : 'bg-slate-800/50 hover:bg-slate-800/70 border-slate-800'
            }`}
          >
            <div className={`mt-0.5 w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${
              selectedMode === 'empty' ? 'border-cyan-600 bg-cyan-600 text-white' : 'border-slate-700'
            }`}>
          ...
          >
            <div className={`mt-0.5 w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${
              selectedMode === 'preset' ? 'border-cyan-600 bg-cyan-600 text-white' : 'border-slate-700'
            }`}>
        ...
        <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-100">
          ...
          <button
            ...
            className="px-5 py-2 rounded-xl text-xs font-semibold text-white bg-cyan-600 hover:bg-cyan-700 disabled:opacity-50 transition-all shadow-2xs cursor-pointer flex items-center gap-2"
          >
