        ...
        <div className="p-6 bg-slate-900 border-b border-slate-800 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <input
              ...
              className="flex-1 bg-slate-950 border border-slate-700 focus:border-blue-500 rounded-xl px-4 py-2.5 text-xs text-slate-100 placeholder-slate-500 outline-none"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs rounded-xl flex items-center justify-center gap-1.5 transition-colors cursor-pointer shrink-0"
              >
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-400 px-1">
            ...
            {results.length > 0 && <span className="text-blue-400 font-mono font-bold">Fetched {results.length} results</span>}
          </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {source === 'semanticscholar' && paper.citationCount !== undefined && (
                          <span className="px-2 py-0.5 text-[10px] font-mono font-bold bg-blue-950 text-blue-300 border border-blue-800 rounded flex items-center gap-1">
