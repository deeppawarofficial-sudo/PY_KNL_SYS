      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-12">
          ...
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-md bg-cyan-600 flex items-center justify-center shadow-md shadow-cyan-950/50">
              <Sparkles className="w-4 h-4 text-white" />
            </div>
            <div className="flex items-center gap-2.5">
              <h1 className="text-sm font-bold text-slate-100 tracking-tight">AI Knowledge Synthesizer</h1>
              <span className="hidden sm:inline-block px-2 py-0.5 text-[10px] font-mono font-bold bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 uppercase tracking-wider rounded-md">
                Multi-Paper RAG
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-slate-400 hover:text-cyan-400 bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-cyan-500/30 rounded-md transition-all cursor-pointer"
            >
