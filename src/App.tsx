...
export default function App() {
  ...
  const speedDialActions = [
    {
      icon: Upload, label: 'Upload PDF', colorClass: 'bg-blue-600 hover:bg-blue-500',
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-950 text-slate-100 font-sans antialiased overflow-hidden selection:bg-blue-600 selection:text-white">
        ...
        >
              ...
              >
                ...
                >
                  ...
                  {id === 'library' && papers.length > 0 && (
                    <span className="ml-2 px-1.5 py-0.5 bg-blue-500/20 text-blue-400 rounded text-[10px] font-mono">
                      {papers.length}
                    </span>
                  )}
                </span>
          ...
          <div className="px-2 pt-3 border-t border-slate-800 mt-3">
            ...
            >
              ...
              {isFloatingChatOpen && (
                <span className="absolute right-2 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse" />
              )}
            </button>
          </div>
        </aside>
      ...
      <div className="fixed bottom-6 left-20 z-40">
        <div className="flex items-center gap-2.5 bg-slate-900/80 backdrop-blur-md border border-slate-700/60 rounded-full px-4 py-2 shadow-xl shadow-black/50 text-xs font-mono select-none">
          ...
          <span className="text-blue-400 font-bold uppercase tracking-wider text-[10px]">Qdrant Live</span>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2.5">
        ...
        <button
          ...
          className="w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-950/60 flex items-center justify-center transition-all hover:scale-105 active:scale-95 cursor-pointer border border-blue-500/30"
        >
          <Plus
